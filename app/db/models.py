...
class UserChannel(SQLModel, table=True):
    ...
    platform: Platform = Field(sa_column=Column(ChoiceType(Platform, impl=Integer()), nullable=False))
...
class Message(SQLModel, table=True):
    ...
    text_embedding: Optional[str] = Field(default=None, index=True, nullable=True, sa_column=Column(Vector))
